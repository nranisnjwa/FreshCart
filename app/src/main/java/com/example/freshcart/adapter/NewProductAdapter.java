package com.example.freshcart.adapter;
...
import com.example.freshcart.activity.MainActivity;
import com.example.freshcart.interfaces.AddorRemoveCallbacks;
import com.example.freshcart.model.Cart;
...
public class NewProductAdapter extends RecyclerView.Adapter<NewProductAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        Picasso.get().load(product.getImage()).error(R.drawable.ic_baseline_person_24).into(holder.imageView, new Callback() {
            @Override
