...
import com.example.freshcart.activity.CartActivity;
import com.example.freshcart.activity.MainActivity;
import com.example.freshcart.adapter.CheckoutCartAdapter;
...
public class ConfirmFragment extends Fragment {
    ...
    private void closeProgress() {
        ...
        Order order = new Order(id, orderNo, currentDateandTime, "Rp. " + _totalAmount, "Pending");
        orderList.add(order);
